...
public:
    ...
    void compute (core::Scene::Ptr scene, ViewportList* viewports);

private:
    void init_from_exif (core::View::Ptr view, Viewport* viewport);
    void init_from_views (core::View::Ptr view, Viewport* viewport);
